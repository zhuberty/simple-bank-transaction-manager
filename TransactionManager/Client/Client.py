...
class PageAdmin(tk.Frame):
    ...
    def configure_console(self, height, width):
        ...
        self.console.grid(
            row=2, column=0, columnspan=3, sticky="nsew"  # Change columnspan to 3
        )
        self.configure_console_scrollbar()
        self.grid_rowconfigure(2, weight=1)
        self.grid_columnconfigure(0, weight=1)
        self.grid_columnconfigure(1, weight=1)
        self.grid_columnconfigure(2, weight=0)  # Set weight to 0
    ...
    def configure_console_scrollbar(self):
        ...
        self.console_scrollbar.grid(row=2, column=2, sticky="nse")  # Change column to 2
